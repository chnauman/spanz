...
<div class="content-box" style="background-color: #fff5f5; border-left-color: #e53e3e;">
    <p style="margin: 0; color: #c53030;"><strong>Subscription Expired:</strong> Your {{ $subscription->name }} subscription has expired as of {{ $expiresAt->format('F j, Y') }}.</p>
</div>
...
<p style="margin-top: 24px;">Thank you for being a valued member, and we hope to welcome you back soon!</p>
@endsection
