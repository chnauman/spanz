    ...
    <div class="bg-gray-100">
        ...
        <div class="px-4 sm:px-6 lg:px-8 pb-12 sm:pb-16 lg:pb-20">
            <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6 lg:gap-8 max-w-7xl mx-auto">
                ...
                <!-- Starter Card -->
                <div
                    class="w-full max-w-sm mx-auto rounded-[20px] sm:rounded-[30px] hover:scale-105 transition-all duration-300 bg-white shadow-[0px_4px_4px_0px_rgba(0,0,0,0.25)]">
                    <div class="px-5 sm:px-7">

                        <h1 class="text-xl sm:text-2xl text-blue-800 font-bold pt-4 sm:pt-5">Starter</h1>
                        <p class="text-xs sm:text-sm text-blue-800 pb-8 sm:pb-12 leading-relaxed">Budget-friendly and
                            user-friendly, ideal for individuals and
                            small
                            businesses seeking essential features for online presence.</p>
                        <h2 class="text-2xl sm:text-3xl text-blue-800 font-bold">$5/day</h2>
                        ...
                        <div class="space-y-2 sm:space-y-3 mt-3">
                            <div class="flex items-center gap-2 sm:gap-3">
                                <img src="./spanz-img/check-mark 1.png" alt=""
                                    class="w-4 h-4 sm:w-5 sm:h-5 flex-shrink-0">
                                <span class="text-blue-800 text-xs sm:text-sm">1 Month package duration</span>
                            </div>
                            <div class="flex items-center gap-2 sm:gap-3">
                                <img src="./spanz-img/check-mark 1.png" alt=""
                                    class="w-4 h-4 sm:w-5 sm:h-5 flex-shrink-0">
                                <span class="text-blue-800 text-xs sm:text-sm">5 Tasks to post</span>
                            </div>
                            <div class="flex items-center gap-2 sm:gap-3">
                                <img src="./spanz-img/check-mark 1.png" alt=""
                                    class="w-4 h-4 sm:w-5 sm:h-5 flex-shrink-0">
                                <span class="text-blue-800 text-xs sm:text-sm">2 Featured task allowed</span>
                            </div>
                            <div class="flex items-center gap-2 sm:gap-3">
                                <img src="./spanz-img/check-mark 1.png" alt=""
                                    class="w-4 h-4 sm:w-5 sm:h-5 flex-shrink-0">
                            ...
                            <div class="flex items-center gap-2 sm:gap-3">
                                <img src="./spanz-img/check-mark.png" alt=""
                                    class="w-4 h-4 sm:w-5 sm:h-5 flex-shrink-0">
                                <span class="text-gray-600 text-xs sm:text-sm">0 Credits required to apply to job</span>
                            </div>
                            <div class="flex items-center gap-2 sm:gap-3">
                                <img src="./spanz-img/check-mark.png" alt=""
                                    class="w-4 h-4 sm:w-5 sm:h-5 flex-shrink-0">
                                <span class="text-gray-600 text-xs sm:text-sm">5 Days featured task duration</span>
                            </div>
                        </div>
                    </div>
                ...
                <div
                    ...
                    <div class="flex justify-center">
                        <img src="./spanz-img/most-popular.svg" alt="" class="absolute -top-2 sm:-top-3 h-6 sm:h-auto">
                    </div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 sm:gap-10 lg:gap-12">
                ...
                <div class="flex flex-col items-center text-center md:col-span-2 lg:col-span-1">
                    <div
                        class="flex justify-center bg-[#416D94] w-16 h-16 sm:w-20 sm:h-20 rounded-full items-center mb-4 sm:mb-6">
                        <svg width="60px" height="60px" viewBox="0 0 48 48" id="Layer_2" data-name="Layer 2" xmlns="http://www.w3.org/2000/svg"><defs>
                            <style>.cls-1{fill:none;stroke:#ffffff;stroke-linecap:round;stroke-linejoin:round;}</style></defs>
