            ...
            <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6 lg:gap-8 max-w-7xl mx-auto">
                ...
                <div
                    ...
                    <div class="px-5 sm:px-7">
                        ...
                        <h1 class="text-xl sm:text-2xl text-blue-800 font-bold pt-4 sm:pt-5">Buryer Onle</h1>
                    ...
                    <div class="flex justify-center pb-4 sm:pb-6">
                        <button class="bg-gray-300 hover:bg-blue-600 hover:text-white mt-4 sm:mt-7 mb-2 sm:mb-3 text-blue-800 font-bold py-2 px-4 sm:px-6 rounded-md text-sm sm:text-base transition-colors">Select
                            Plan</button>
                    </div>
                </div>
                <!-- Professional Card -->
