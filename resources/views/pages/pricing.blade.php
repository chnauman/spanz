...
@section('content')
    @include('components.smallheader')
    <div class="bg-gray-100">
        ...
        <div class="px-4 sm:px-6 lg:px-8 pb-12 sm:pb-16 lg:pb-20">
            <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6 lg:gap-8 max-w-7xl mx-auto">
                ...
                <!-- Starter Card -->
                <div
                    class="w-full max-w-sm mx-auto h-96 rounded-[20px] sm:rounded-[30px] hover:scale-105 transition-all duration-300 bg-white shadow-[0px_4px_4px_0px_rgba(0,0,0,0.25)] flex flex-col">
                    <div class="px-5 sm:px-7 flex-1">

                        <h1 class="text-xl sm:text-2xl text-blue-800 font-bold pt-4 sm:pt-5">Free</h1>
                        <h1 class="text-xl sm:text-2xl text-blue-800 font-bold pt-4 sm:pt-5">Buryers Only</h1>
                        <p class="text-xs sm:text-sm text-blue-800 pb-8 sm:pb-12 leading-relaxed">Post unlimited buying
                            request (RFX) to get
                            competitive price quotes
                            for your projects.</p>
                        
                    </div>
                    <div class="flex justify-center pb-4 sm:pb-6 mt-auto" >
                        <button class="bg-gray-300 hover:bg-blue-600 hover:text-white mt-4 sm:mt-7 mb-2 sm:mb-3 text-blue-800 font-bold py-2 px-4 sm:px-6 rounded-md text-sm sm:text-base transition-colors">Select Plan</button>
                    </div>
                </div>
                <!-- Professional Card -->
                <div
                    ...
                    <div
                        ...
                        <svg fill="#ffffff" width="60px" height="60px" viewBox="0 0 32 32"
                            ...
                            <g id="Icon">
                                ...
                                <path
                                    d="M15.994,3.988c-2.763,-0 5.006,2.243 5.006,5.006c-0,2.763 -2.243,5.006 -5.006,5.006c-2.763,0 -5.006,-2.243 -5.006,-5.006c-0,-1.659 1.347,-3.006 3.006,-3.006Z" />
