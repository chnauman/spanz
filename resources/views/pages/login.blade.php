    ...
    <div class="bg-white rounded-lg w-96 sm:rounded-xl shadow-xl max-w-xs sm:max-w-sm md:max-w-md p-4 sm:p-6 md:p-8">
        ...
        <form class="space-y-3 sm:space-y-4" method="post" action="#">
            ...
            <div class="flex  xs:flex-row xs:items-center xs:justify-between justify-between gap-2 sm:gap-0 pt-2">
                <label class="flex items-center">
                    <input type="checkbox" class="h-3 w-3 sm:h-4 sm:w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded">
                    <span class="ml-2 text-xs sm:text-sm text-gray-600">Remember me</span>
                </label>
                <a href="#" class="text-xs sm:text-sm text-blue-600 hover:text-blue-500 transition-colors underline xs:no-underline xs:hover:underline">Forgot password?</a>
            </div>
        ...
        <div class="mt-4 sm:mt-6 text-center">
            <p class="text-xs sm:text-sm text-gray-600">
                ...
                <a href="{{ url('createac') }}" class="text-blue-600 hover:text-blue-500 font-medium transition-colors">Join SPANZ</a>
            </p>
        </div>
    </div>
</div>
