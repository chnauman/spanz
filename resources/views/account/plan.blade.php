                                            ...
                                            <div class="spanz-plan-card-face bg-white border-2 border-gray-300 rounded-xl p-4 hover:shadow-lg transition-all duration-300">
                                                @if($subscription->name === 'Professional')
                                                    <div class="mb-2 flex justify-end">
                                                        <span class="inline-block bg-gray-800 text-white px-3 py-1 rounded-full text-[10px] font-bold uppercase tracking-wide shadow-lg" style="font-size:10px;letter-spacing:0.05em;">Most Popular</span>
                                                    </div>
                                                @endif
                                                ...
                                                <div class="spanz-plan-card-stack">
                                                    <div class="spanz-plan-card-body text-center">
                                                        ...
                                                        <div class="bg-blue-50 rounded-lg p-3 mb-2" style="background-color:#eff6ff;">
