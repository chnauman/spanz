                            ...
                            <div class="overflow-x-auto">
                                <table class="w-full table-fixed divide-y divide-gray-200">
                                    <thead class="bg-gray-50">
                                        <tr>
                                            <th class="px-4 sm:px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider w-3/12">User</th>
                                            <th class="px-4 sm:px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider w-4/12">Email</th>
                                            <th class="px-4 sm:px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider w-2/12">Start Date</th>
                                            <th class="px-4 sm:px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider w-2/12">Expires</th>
                                            <th class="px-4 sm:px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider w-1/12">Status</th>
                                        </tr>
                                    </thead>
                                    <tbody class="bg-white divide-y divide-gray-200">
                                        @foreach($subscription->userSubscriptions as $userSubscription)
                                        <tr>
                                            <td class="px-4 sm:px-6 py-4 text-sm font-medium text-gray-900 min-w-0">
                                                <span class="block truncate" title="{{ $userSubscription->user->name }}">{{ $userSubscription->user->name }}</span>
                                            </td>
                                            <td class="px-4 sm:px-6 py-4 text-sm text-gray-500 min-w-0">
                                                <span class="block truncate" title="{{ $userSubscription->user->email }}">{{ $userSubscription->user->email }}</span>
                                            </td>
