...
@section('title', 'Create Tender View Pricing Rule')
    ...
    <div class="w-full">
        <div class="border border-gray-300 p-3 sm:p-4 lg:p-6 bg-white rounded-lg shadow-sm">
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between rounded-sm bg-[#092C48] text-white p-4 mt-6 sm:mt-8 lg:mt-10 space-y-2 sm:space-y-0">
                <h1 class="text-xl sm:text-2xl font-bold">Add Pricing Rule</h1>
            ...
            <form action="{{ route('admin.tender-view-pricing.store') }}" method="POST" class="mt-6">
                @csrf

                @include('admin.tender-view-pricing._form', ['rule' => null])
