...
<body>
    <aside>
        <div class="flex h-screen">
            <!-- sidebar: fixed width on large screens, hidden on small -->
            <div class="hidden lg:block w-48 flex-shrink-0 bg-gradient-to-l from-[#092C48] to-[#1b3963]">
                <div
            ...
            <div class="flex-1 flex flex-col p-5 lg:p-10 overflow-y-auto">
        ...
        <div id="editModal" class="fixed inset-0 bg-black bg-opacity-50 hidden items-center justify-center z-50">
            <div class="bg-white rounded-lg p-6 w-full max-w-md mx-4">
                ...
                <form onsubmit="saveProfile(event)" class="space-y-4">
                    ...
                    <!-- Name Input -->
                    <div>
                        <label for="profileNameInput" class="block text-sm font-medium text-gray-700 mb-2">Full
                            Name</label>
