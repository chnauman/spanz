...
<head>
    ...
    <style>
        ...
        .thomas-result-card {
            ...
            border-radius: 6px;
            box-shadow: 0 2px 8px rgba(3, 39, 71, 0.05);
        }
        ...
        <div class="w-full max-w-6xl mx-auto px-4 sm:px-8">
            <div class="thomas-search-shell flex flex-col sm:flex-row items-center justify-center gap-2 sm:gap-0">
                <div class="w-full sm:w-auto">
                    <select id="tenders-search-type" class="w-full sm:w-56 px-4 py-3 sm:py-2 bg-gray-50 text-gray-700 text-sm">
                                ...
                                <li class="category-group" data-scope="desktop">
                                    <div class="flex items-start gap-3">
                                        <input type="checkbox"
                                            ...
                                            {{ $isParentChecked ? 'checked' : '' }}>
                                        <button type="button"
                                            class="thomas-filter-label text-left text-sm sm:text-md hover:underline select-none category-toggle category-label {{ $isExpanded ? 'font-semibold' : '' }}"
                                        ...
                                        @foreach($category->children as $child)
                                            <div class="flex items-start gap-2">
                                                ...
                                                <input type="checkbox"
                                                    ...
                                                    data-parent-id="{{ $category->id }}"
                                                    {{ in_array((int) $child->id, $selectedCategories, true) ? 'checked' : '' }}>
                                                <span class="thomas-filter-label text-sm sm:text-md text-gray-700 select-none category-label">{{ $child->name }}</span>
                                            </div>
                                        @endforeach
                                    </div>
                                </li>
