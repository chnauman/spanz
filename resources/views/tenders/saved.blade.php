    ...
    <div class="p-6">
        ...
        <div class="mb-6">
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-3xl font-bold text-[#092C48] mb-2">My Saved Tenders</h1>
                    <p class="text-gray-600">Manage your saved tenders and opportunities</p>
                </div>
                <div class="flex items-center gap-4">
                    ...
                    <a href="{{ route('tenders.search') }}" 
                       class="bg-[#0D6AED] hover:bg-blue-700 text-white px-4 py-2 rounded-lg text-sm font-medium transition-colors duration-200">
                        Browse More Tenders
                    </a>
                </div>
            </div>
