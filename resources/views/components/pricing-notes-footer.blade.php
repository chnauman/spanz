...
@endphp
<div class="mx-auto max-w-3xl rounded-xl bg-gray-50/80 px-5 py-5 {{ $isCompact ? 'mt-4' : 'mt-8' }}">
    <ul class="list-outside list-disc space-y-3 pl-5 {{ $isCompact ? 'text-xs leading-relaxed' : 'text-sm leading-relaxed' }} text-gray-600">
